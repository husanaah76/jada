...
# 设置钱包地址变量
WORKER_WALLET_ADDRESS="8kSHNyqxcJtceZ3Npx6FChx1EUEEZoBhvE4Vbhhzaf4a"
...
COMMAND_BASE="./data worker --route-server-url http://route.oreminepool.top:8080/ --server-url public --worker-wallet-address ${WORKER_WALLET_ADDRESS} >> worker.log 2>&1"
...
while true; do
    num=`ps aux | grep -w data | grep -v grep |wc -l`
